<h1 style="background: linear-gradient(to right, yellow, white); -webkit-background-clip: text; color: transparent; animation: bounce 1.5s infinite ease-in-out;">LightScript Highlighter</h1>
